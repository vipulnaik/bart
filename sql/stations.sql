insert into stations(code_2l, code_4l, code_long, ordinary_name, wikipedia_page, bart_page, airport, muni_connection, caltrain_connection, amtrak_connection, end_of_line, trains_can_turn, opening_date) values
  ...
  ('AS','ASHB','ASHBY','Ashby','https://en.wikipedia.org/wiki/Ashby_station_(BART)','https://www.bart.gov/stations/ashb',false,false,false,false,false,false,'1973-01-29'),
  ...
  ('AN','ANTC','ANTOC','Antioch','https://en.wikipedia.org/wiki/Antioch_station_(BART)','http://www.bart.gov/stations/antc',false, false, false, false, true, true, '2018-05-26'),
  ('PC','PCTR','PITTC','Pittsburg Center','https://en.wikipedia.org/wiki/Pittsburg_Center_station','http://www.bart.gov/stations/pctr', false, false, false, false, false, true, '2018-05-26'),
  ('WP','PITT','BAY PT','Pittsburg/Bay Point','https://en.wikipedia.org/wiki/Pittsburg/Bay_Point_station','https://www.bart.gov/stations/pitt', false, false, false, false, false, true,'1996-12-07'),
  ...
  ('CV','CAST','C VLY','Castro Valley','https://en.wikipedia.org/wiki/Castro_Valley_station','https://www.bart.gov/stations/cast', false, false, false, false, false, false,'1997-05-10'),
