insert into stations(code_2l, code_4l, code_long, ordinary_name, wikipedia_page, bart_page, airport, muni_connection, caltrain_connection, amtrak_connection, end_of_line, trains_can_turn, opening_date) values
  ...
  ('??','ANTC','???','Antioch','https://en.wikipedia.org/wiki/Antioch_station_(BART)','http://www.bart.gov/stations/antc',false, false, false, false, true, true, '2018-05-26'),
  ('??','PCTR','???','Pittsburg Center','https://en.wikipedia.org/wiki/Pittsburg_Center_station','http://www.bart.gov/stations/pctr', false, false, false, false, false, true, '2018-05-26'),
